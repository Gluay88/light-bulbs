...
class Bulbs extends Component {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-26 -50 350 350" id="bulbs">

	<path style={{fill: this.props.switch, stroke:"rgb(4, 4, 123)", strokeWidth:"5px" }} d="M148.532,0c-45.68,0-82.876,44.488-82.876,99.372c0,36.958,16.541,69.202,41.541,86.323v13.533c0,8.284,7.049,15,15.333,15
	...
	<path style={{fill: this.props.switch, stroke:"rgb(4, 4, 123)", strokeWidth:"5px" }}d="M190.281,231.229h-82.5c-4.557,0-8.583,3.693-8.583,8.25v0.5c0,3.569,2.271,6.601,5.443,7.75
